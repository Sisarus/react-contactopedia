...
const Contact = (props) => {
  return(
    <div className="row p-md-1 md-2" style={{borderRadius: "20px", border: "1px solid #555"}}>
      <div className="col-2 col-md-1 pt-2 pt-md-1">
          <img src={`http://ui-avatars.com/api/?name=${props.contact.name}`} alt="name" style={{width: '80%'}}></img>
      </div>
      ...
      <div className="col-2 col-md-3 pt-md-3">
        ...
        <button className="btn btn-danger btn-sm m-1">
          <i className="bi bi-trash-fill" style={{fontSize: '1rem'}} onClick={()=> props.deleteClick(props.contact)}></i>
        </button>
      </div>
    </div>
  )
