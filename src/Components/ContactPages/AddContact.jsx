        ...
        <form onSubmit={this.handleAddContactFormSubmit}>
          <div className="row p-2"> 
            ...
            <div className="col-12 col-md-4 p-1">
              <input className="form-control form-control-sm" placeholder="Name..." type="text" name="contactName"></input>
            </div>
            <div className="col-12 col-md-4 p-1">
              <input className="form-control form-control-sm" placeholder="Email..." type="text" name="contactEmail"></input>
            </div>
            <div className="col-12 col-md-4 p-1">
